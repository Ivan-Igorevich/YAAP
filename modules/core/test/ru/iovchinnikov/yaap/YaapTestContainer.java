...
public class YaapTestContainer extends TestContainer {

    public YaapTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/iovchinnikov/yaap/app.properties",
    ...
    public static class Common extends YaapTestContainer {

        public static final YaapTestContainer.Common INSTANCE = new YaapTestContainer.Common();
